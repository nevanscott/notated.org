...
This site is typeset in [Gestura Text](https://socio-type.com/demo/gestura-text) and [Schibsted Grotesk](https://fonts.google.com/specimen/Schibsted+Grotesk), and built with [Jekyll](https://jekyllrb.com) served from [Netlify](https://www.netlify.com). The circled "n" mark is set in [Piazzolla](https://piazzolla.huertatipografica.com) designed by Juan Pablo del Peral.
